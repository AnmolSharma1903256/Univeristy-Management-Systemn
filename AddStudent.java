...
class AddStudent implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id13,id14,id15,id16,id17,lab,lab1,lab2;
    ...
    public AddStudent(){
       ...
       String course[] = {"B.Tech","BBA","BCA","BSC","MSC","MBA","MCA","BA","B.Com"};
       ...
       String Branch[] = {"Computer Science","Electrical","Information Technology","Mechanical ","Civil"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                JOptionPane.showMessageDialog(null,"Student Details Inseerted Successfully");
                f.setVisible(false);
            }
            catch(Exception ee){
